...
sub _compute_ch {
  ...
  my @mixo;
  my ($init, $a, $b, $c, $k) = (0xe6359a60, 0x9e3779b9, 0x9e3779b9, 0xe6359a60, 0);
  my $len = scalar @url;
...
Google::PageRank - Query google pagerank of page
...
The C<Google::PageRank> is a class implementing a interface for
querying google pagerank.

To use it, you should create C<Google::PageRank> object and use its
...
=item  $gpr = Google::PageRank->new(%options);

This method constructs a new C<Google::PageRank> object and returns it.
